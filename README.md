...
// All old menus have been removed and most likely will return with better versions (:
// All menus here were developed by -> luxury cheats#1631
// you're open to use these for ur cheat please give me credit by simply @everyone/@here menu developed by: luxury cheats#1631 (if you dont idrc)
#include "csgotexture.h"
...
public:
	...
	void ModernCustom();        // Sleek Clean looking design.
	void CheatLoverzLite();     // There Nuclear looking menu not the new shit menu
	void Tutorial();            // if you cant figure out how to use this, this will be the first thing to open when debugging!
	void CSGOCustom();
	void CSGOCustom2();
	void RustCustom();
...
namespace csgo
{
	...
	rainbowbar r_csgo_;
	inline rainbowbar* r_csgo = new rainbowbar;
...
namespace Draw
{
	...
	// for the pro 1337 developers (gets confusing on some things easier method below it)
	...
	colors colortype;
	colors ct;
	inline colors* color_m = new colors;
	inline colors* col = new colors;
